...
class IBPI_WeaponInteraction_C final : public IInterface
{
public:
...
static_assert(alignof(IBPI_WeaponInteraction_C) == 0x000008, "Wrong alignment on IBPI_WeaponInteraction_C");
static_assert(sizeof(IBPI_WeaponInteraction_C) == 0x000028, "Wrong size on IBPI_WeaponInteraction_C");
