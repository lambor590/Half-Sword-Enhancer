...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07C409E0;
	constexpr int32 AppendString      = 0x010C3960;
	constexpr int32 GNames            = 0x07B89C80;
	constexpr int32 GWorld            = 0x07DC0AF0;
	constexpr int32 ProcessEvent      = 0x012AC680;
...
enum class EObjectFlags : int32
{
	...
	AllocatedInSharedPage			= 0x20000000,
};
