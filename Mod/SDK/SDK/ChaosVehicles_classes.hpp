...
{
public:
	uint8                                         Pad_368[0x778];                                    // 0x0368(0x0778)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class USkeletalMeshComponent*                 Mesh;                                              // 0x0318(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UChaosVehicleMovementComponent*         VehicleMovementComponent;                          // 0x0320(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AWheeledVehiclePawn) == 0x000328, "Wrong size on AWheeledVehiclePawn");
static_assert(offsetof(AWheeledVehiclePawn, Mesh) == 0x000318, "Member 'AWheeledVehiclePawn::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehiclePawn, VehicleMovementComponent) == 0x000320, "Member 'AWheeledVehiclePawn::VehicleMovementComponent' has a wrong offset!");
