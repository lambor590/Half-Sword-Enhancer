...
public:
	...
	TSubclassOf<class UObject>                    MetaSoundUClass;                                   // 0x0200(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
