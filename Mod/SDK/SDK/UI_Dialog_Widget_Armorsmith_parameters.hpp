...
struct UI_Dialog_Widget_Armorsmith_C_ExecuteUbergraph_UI_Dialog_Widget_Armorsmith final
{
public:
	...
	class UUI_Armorer_Frank_C*                    CallFunc_Create_ReturnValue;                       // 0x0020(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_True_if_break_was_hit_Variable_2;        // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUI_Tavern_Dialog_C*>            CallFunc_GetAllWidgetsOfClass_FoundWidgets_1;      // 0x0080(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UUI_Tavern_Dialog_C*                    CallFunc_Array_Get_Item_1;                         // 0x0090(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUI_Hub_Tavern_C*>               CallFunc_GetAllWidgetsOfClass_FoundWidgets_2;      // 0x00A0(0x0010)(ReferenceParm, ContainsInstancedReference)
...
struct UI_Dialog_Widget_Armorsmith_C_PreConstruct final
{
public:
