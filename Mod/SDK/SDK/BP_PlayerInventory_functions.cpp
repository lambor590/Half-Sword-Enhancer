...
void ABP_PlayerInventory_C::ExecuteUbergraph_BP_PlayerInventory(int32 EntryPoint)
{
...
void ABP_PlayerInventory_C::LoadSaveGame()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerInventory_C", "LoadSaveGame");
...
void ABP_PlayerInventory_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;
