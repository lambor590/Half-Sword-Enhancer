...
// Enum_ShapeType                          Shape_Type                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Shape_Edge_Falloff                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Local_Space_Coordinates_                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                                    Self_Shadow_from_Directional_Light_                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// double                                  Noise___Multiply                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FVector&                   Panning_speed                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Rotation_Speed                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// const struct FLinearColor&              Emissive_Color                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// double                                  Godrays_Scale                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// Enum_DistortionPattern                  Distortion_Pattern                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FVector2D&                 Distortion_Scale                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// double                                  Far_Fade_Distance                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Near_Fade_Distance                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Flowmap_Strength                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Allow_Interaction_                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_UltraVolumetricsParent_C::SetAllParameters(Enum_NoisePattern Noise_Patterm, Enum_ShapeType Shape_Type, double Shape_Edge_Falloff, bool Local_Space_Coordinates_, bool Use_DF_, double DF___Height, double DF___Contrast, double Opacity, double SelfShadowAmount, double SelfShadow_Contrast, bool Self_Shadow_from_Directional_Light_, const struct FVector& Noise_Size, double Noise___Power, double Noise___Multiply, const struct FVector& Panning_speed, double Rotation_Speed, const struct FLinearColor& Color, const struct FLinearColor& Emissive_Color, double SinePanAmount, double Godray_Amount, double Godrays_Scale, Enum_DistortionPattern Distortion_Pattern, const struct FVector2D& Distortion_Scale, double Distortion_Strength, double Distortion_Z_Strength, double Far_Fade_Distance, double Near_Fade_Distance, double Flowmap_Strength, bool Allow_Interaction_)
{
	...
	Parms.Shape_Type = Shape_Type;
	Parms.Shape_Edge_Falloff = Shape_Edge_Falloff;
	Parms.Local_Space_Coordinates_ = Local_Space_Coordinates_;
	...
	Parms.Self_Shadow_from_Directional_Light_ = Self_Shadow_from_Directional_Light_;
	Parms.Noise_Size = std::move(Noise_Size);
	Parms.Noise___Power = Noise___Power;
	Parms.Noise___Multiply = Noise___Multiply;
	Parms.Panning_speed = std::move(Panning_speed);
	Parms.Rotation_Speed = Rotation_Speed;
	Parms.Color = std::move(Color);
	Parms.Emissive_Color = std::move(Emissive_Color);
	Parms.SinePanAmount = SinePanAmount;
	Parms.Godray_Amount = Godray_Amount;
	Parms.Godrays_Scale = Godrays_Scale;
	Parms.Distortion_Pattern = Distortion_Pattern;
	Parms.Distortion_Scale = std::move(Distortion_Scale);
	Parms.Distortion_Strength = Distortion_Strength;
	Parms.Distortion_Z_Strength = Distortion_Z_Strength;
	Parms.Far_Fade_Distance = Far_Fade_Distance;
	Parms.Near_Fade_Distance = Near_Fade_Distance;
	Parms.Flowmap_Strength = Flowmap_Strength;
	Parms.Allow_Interaction_ = Allow_Interaction_;
