...
public:
	...
	class UPhysicsControlProfileAsset*            PhysicsControlProfileAsset;                        // 0x0310(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
