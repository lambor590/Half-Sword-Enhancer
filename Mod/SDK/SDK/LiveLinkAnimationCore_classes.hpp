...
{
public:
	class ULiveLinkRetargetAsset*                 CurrentRetargetAsset;                              // 0x0368(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
