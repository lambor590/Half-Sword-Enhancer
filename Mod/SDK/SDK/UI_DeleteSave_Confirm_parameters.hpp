...
struct UI_DeleteSave_Confirm_C_ExecuteUbergraph_UI_DeleteSave_Confirm final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Array_Index_Variable;                     // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUI_CharacterCreation_C*                CallFunc_Create_ReturnValue;                       // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_True_if_break_was_hit_Variable_3;        // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUI_Tavern_Dialog_C*>            CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x0078(0x0010)(ReferenceParm, ContainsInstancedReference)
	TArray<class UUI_Hub_Tavern_C*>               CallFunc_GetAllWidgetsOfClass_FoundWidgets_1;      // 0x0088(0x0010)(ReferenceParm, ContainsInstancedReference)
	...
	class UUI_Hub_Tavern_C*                       CallFunc_Array_Get_Item_1;                         // 0x00A0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUI_Tevern_LowerPanel_C*>        CallFunc_GetAllWidgetsOfClass_FoundWidgets_2;      // 0x00B8(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UUI_Tevern_LowerPanel_C*                CallFunc_Array_Get_Item_2;                         // 0x00C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FStr_Passport_Character1               CallFunc_Map_Find_Value;                           // 0x00F0(0x0140)(HasGetValueTypeHash)
	...
	TArray<class UUI_Dialog_Widget_Innkeeper_ResetCharacter_C*> CallFunc_GetAllWidgetsOfClass_FoundWidgets_3; // 0x0238(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UUI_Dialog_Widget_Innkeeper_ResetCharacter_C* CallFunc_Array_Get_Item_4;                   // 0x0248(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_BooleanAND_ReturnValue_3;                 // 0x0255(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function UI_DeleteSave_Confirm.UI_DeleteSave_Confirm_C.PreConstruct
// 0x0001 (0x0001 - 0x0000)
struct UI_DeleteSave_Confirm_C_PreConstruct final
{
public:
