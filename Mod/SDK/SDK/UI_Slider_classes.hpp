...
public:
	...
	TMulticastInlineDelegate<void(double SliderValue_0, bool bReset)> OnSliderValueChanged;          // 0x03E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
