...
public:
	...
	TArray<class UUI_Lose_C*>                     CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x0048(0x0010)(ReferenceParm, ContainsInstancedReference)
	TArray<class UUI_DeathDoor_C*>                CallFunc_GetAllWidgetsOfClass_FoundWidgets_1;      // 0x0058(0x0010)(ReferenceParm, ContainsInstancedReference)
	...
	float                                         CallFunc_SetGlobalTimeDilation_TimeDilation_ImplicitCast; // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetGlobalTimeDilation_TimeDilation_ImplicitCast_1; // 0x007C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
