...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"UI_Lose_C">();
	}
...
static_assert(offsetof(UUI_Lose_C, RestartButtonAppear) == 0x0002F8, "Member 'UUI_Lose_C::RestartButtonAppear' has a wrong offset!");
static_assert(offsetof(UUI_Lose_C, TextAppear) == 0x000300, "Member 'UUI_Lose_C::TextAppear' has a wrong offset!");
static_assert(offsetof(UUI_Lose_C, Fade) == 0x000308, "Member 'UUI_Lose_C::Fade' has a wrong offset!");
