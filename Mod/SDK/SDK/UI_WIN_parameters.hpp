...
public:
	...
	class UUI_NextFIght_C*                        CallFunc_Create_ReturnValue;                       // 0x0068(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUI_WIN_C*>                      CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x00F8(0x0010)(ReferenceParm, ContainsInstancedReference)
	...
	float                                         CallFunc_SetOpacity_InOpacity_ImplicitCast;        // 0x012C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
