...
class UUI_StartUpScreen_5_C final : public UUserWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_UI_StartUpScreen_5(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("UI_StartUpScreen_5_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"UI_StartUpScreen_5_C")
	}
	static class UUI_StartUpScreen_5_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UUI_StartUpScreen_5_C>();
	}
};
