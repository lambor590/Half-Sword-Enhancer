...
{
public:
	uint8                                         Pad_738[0x468];                                    // 0x0738(0x0468)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	class UCurveFloat*                            CustomCurve;                                       // 0x00B0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
using FDelegateSignature_OnMontagePlayDelegate = void(class FName NotifyName);
}
