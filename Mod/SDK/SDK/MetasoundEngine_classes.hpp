...
{
public:
	TArray<class UMetasoundGeneratorHandle*>      TrackedGenerators;                                 // 0x0040(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0290(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	uint8                                         Pad_30[0x8];                                       // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, class UMetaSoundBuilderBase*> NamedBuilders;                                   // 0x0038(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x06D8(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
