...
void UUI_WinScreen_Versus_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_WinScreen_Versus_C", "PreConstruct");

	Params::UI_WinScreen_Versus_C_PreConstruct Parms{};
