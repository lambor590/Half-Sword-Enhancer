...
public:
	...
	Enum_PlayMode                                 Temp_byte_Variable;                                // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUI_WIN_C*                              CallFunc_Array_Get_Item;                           // 0x00D8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_Has_Been_Initd_Variable_1;               // 0x01A9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsGamePaused_ReturnValue;                 // 0x01AA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UGI_Settings_C*                         K2Node_DynamicCast_AsGI_Settings_1;                // 0x01B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UWorld>                  K2Node_Select_Default;                             // 0x01E0(0x0028)(ConstParm, UObjectWrapper, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_IsDesignTime;                         // 0x020B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_20C[0x4];                                      // 0x020C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UUI_Lose_C*>                     CallFunc_GetAllWidgetsOfClass_FoundWidgets_1;      // 0x0210(0x0010)(ReferenceParm, ContainsInstancedReference)
	class FString                                 CallFunc_Conv_NameToString_ReturnValue;            // 0x0220(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class UUI_Lose_C*                             CallFunc_Array_Get_Item_1;                         // 0x0230(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUI_GiveUp_C*>                   CallFunc_GetAllWidgetsOfClass_FoundWidgets_2;      // 0x0240(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UUI_GiveUp_C*                           CallFunc_Array_Get_Item_2;                         // 0x0250(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_IsClosed_Variable_1;                     // 0x025D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetGlobalTimeDilation_TimeDilation_ImplicitCast; // 0x0284(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetGlobalTimeDilation_TimeDilation_ImplicitCast_1; // 0x0288(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
